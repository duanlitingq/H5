<template>
    ...
    <div class="aps">
        <!--黄色头部-->
        <div class="heder">
            <!--<img src="../assets/image/fanhui.png" class="heder_img" @click="breakPage('home')" alt="">-->
    ...
    export default {
        ...
        methods: {
            ...
            loadData(pageNum,fn){
                ...
                console.log("新订单的supplierid", supplierId)
                ...
                that.$fetch(apiUrl + '/page/supplier/order/findPage', {
                    ...
                    .then((response) => {
                        console.log(response.data[1], "新订单")
            ...
            orderDetail(orderNo) {
                this.$router.push({
                    name: 'orderlist',
                    query: {preRouter: "neworder", orderNo: orderNo, supplierId: this.supplierId}
                })
            },
            sureOrder(orderId) {
                // 接单
            ...
            prePage(router) {
                ...
                console.log(supplierId, "新订单的supplierId");
